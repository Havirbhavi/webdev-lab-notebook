...
const forEachPokemon = function () {
  ...
  pokemons.forEach(function (pokemon) {
    output += `#${pokemon.id} ${pokemon.name} - ${pokemon.types.join(" / ")}\n`;
  });
...
const searchPokemons = function (query) {
  ...
  return pokemons.filter(function (pokemon) {
    ...
    const typeMatch = pokemon.types.some(function (type) {
...
const reducePokemons = pokemons.reduce(function (typeCounts, pokemon) {
